...
const tabs = [
  ...
  { label: 'Debug Report', href: '/leads/report', icon: FileText },
];
        ...
        <div className="px-6 pt-6 pb-0" style={{ borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
          <div className="max-w-screen-2xl mx-auto">
            ...
            <p className="text-sm mb-4" style={{ color: 'rgba(148,163,184,0.6)' }}>
              Manage and track your leads pipeline — view, add, edit, and convert leads to clients.
            </p>
            {/* Tab Navigation */}
            <div className="flex items-center gap-1">
              {tabs.map((tab) => {
                const isActive =
                  tab.href === '/leads'
                    ? pathname === '/leads' || (pathname.startsWith('/leads/') && !pathname.startsWith('/leads/report'))
