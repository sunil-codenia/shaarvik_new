...
import { LayoutList, Bug } from 'lucide-react';
import Icon from '@/components/ui/AppIcon';


const tabs = [
  { label: 'Plans', href: '/plans', icon: LayoutList },
  { label: 'Debug Report', href: '/plans/report', icon: Bug },
];
        ...
        <div className="px-6 pt-6 pb-0" style={{ borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
          <div className="max-w-screen-2xl mx-auto">
            ...
            <p className="text-sm mb-4" style={{ color: 'rgba(148,163,184,0.6)' }}>
              Manage SaaS plans, pricing, and module assignments.
            </p>
            {/* Tab Navigation */}
            <div className="flex items-center gap-1">
              {tabs.map((tab) => {
                const isActive =
                  tab.href === '/plans'
                    ? pathname === '/plans' || (pathname.startsWith('/plans/') && !pathname.startsWith('/plans/report'))
