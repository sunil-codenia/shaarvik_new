...
const tabs = [
  ...
  { label: 'Debug Report', href: '/companies/report', icon: Bug },
];
        ...
        <div className="px-6 pt-6 pb-0" style={{ borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
          <div className="max-w-screen-2xl mx-auto">
            ...
            <p className="text-sm mb-4" style={{ color: 'rgba(148,163,184,0.6)' }}>
              Manage SaaS platforms, modules, and company configurations.
            </p>
            {/* Tab Navigation */}
            <div className="flex items-center gap-1">
              {tabs.map((tab) => {
                const isActive =
                  tab.href === '/companies'
                    ? pathname === '/companies' || (pathname.startsWith('/companies/') && !pathname.startsWith('/companies/report'))
